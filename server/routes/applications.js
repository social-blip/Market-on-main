...
router.post('/submit',
  ...
  compressUpload,
  [
    body('contact_name').notEmpty().withMessage('Name is required').trim(),
    ...
    body('description').notEmpty().withMessage('Business description is required').trim(),
    body('booth_size').isIn(['single', 'double']).withMessage('Please select a booth size'),
    body('markets_requested').isIn(['3', '6', '10']).withMessage('Please select the number of markets'),
    body('requested_dates').notEmpty().withMessage('Please select at least one market date'),
    body('needs_power').custom(value => ['true', 'false', true, false].includes(value)).withMessage('Please indicate if you need power'),
    body('is_nonprofit').custom(value => ['true', 'false', true, false].includes(value)).withMessage('Please indicate if you are a nonprofit'),
    body('agreements').notEmpty().withMessage('You must agree to all terms before submitting')
  ],
  async (req, res) => {
